...
class UserInfosControllerTest < ActionController::TestCase
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post :create, user_info: { age: @user_info.age, birthday: @user_info.birthday, childs_status: @user_info.childs_status, domiciliary_reg: @user_info.domiciliary_reg, education: @user_info.education, education_from: @user_info.education_from, gender: @user_info.gender, marital_status: @user_info.marital_status, show_id: @user_info.show_id, status: @user_info.status }
    end
  ...
  test "should update user_info" do
    patch :update, id: @user_info, user_info: { age: @user_info.age, birthday: @user_info.birthday, childs_status: @user_info.childs_status, domiciliary_reg: @user_info.domiciliary_reg, education: @user_info.education, education_from: @user_info.education_from, gender: @user_info.gender, marital_status: @user_info.marital_status, show_id: @user_info.show_id, status: @user_info.status }
    assert_redirected_to user_info_path(assigns(:user_info))
  end
